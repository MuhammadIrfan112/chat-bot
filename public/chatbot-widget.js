(function() {
  ...
  var openStyle = "position: fixed; bottom: 20px; right: 20px; width: 375px; height: 520px; border: none; z-index: 2147483647; background: transparent; pointer-events: auto; transition: all 0.35s cubic-bezier(0.34,1.56,0.64,1); color-scheme: light; overflow: hidden;";
