...
(function() {
  ...
  var openStyle = "position: fixed; bottom: 20px; " + position + ": 16px; width: 420px; height: 700px; max-height: calc(100vh - 30px); border: none; border-radius: 22px; overflow: hidden; z-index: 2147483647; background: transparent; pointer-events: auto; box-shadow: 0 8px 40px rgba(0,0,0,0.22); transition: all 0.35s cubic-bezier(0.34,1.56,0.64,1); color-scheme: light;";
